...
define(__m[2/*vs/base/common/ternarySearchTree*/], __M([0/*require*/,1/*exports*/,7/*vs/base/common/arrays*/,8/*vs/base/common/strings*/]), function (require, exports, arrays_1, strings_1) {
    ...
    class ConfigKeysIterator {
        ...
        cmp(a) {
            return this.e
                ? (0, strings_1.compareSubstring)(a, this.b, 0, a.length, this.c, this.d)
                : (0, strings_1.compareSubstringIgnoreCase)(a, this.b, 0, a.length, this.c, this.d);
        }
        value() {
    ...
    class PathIterator {
        ...
        cmp(a) {
            return this.g
                ? (0, strings_1.compareSubstring)(a, this.b, 0, a.length, this.d, this.e)
                : (0, strings_1.compareSubstringIgnoreCase)(a, this.b, 0, a.length, this.d, this.e);
        }
        value() {
    ...
    class UriIterator {
        ...
        reset(key) {
            ...
            if (this.c.path) {
                this.b = new PathIterator(false, !this.f(key));
        ...
        cmp(a) {
            if (this.d[this.e] === 1 /* UriIteratorState.Scheme */) {
                return (0, strings_1.compareIgnoreCase)(a, this.c.scheme);
            }
            else if (this.d[this.e] === 2 /* UriIteratorState.Authority */) {
                return (0, strings_1.compareIgnoreCase)(a, this.c.authority);
            }
            else if (this.d[this.e] === 3 /* UriIteratorState.Path */) {
                return this.b.cmp(a);
            }
            else if (this.d[this.e] === 4 /* UriIteratorState.Query */) {
                return (0, strings_1.compare)(a, this.c.query);
            }
            else if (this.d[this.e] === 5 /* UriIteratorState.Fragment */) {
                return (0, strings_1.compare)(a, this.c.fragment);
            }
            throw new Error();
        }
        value() {
