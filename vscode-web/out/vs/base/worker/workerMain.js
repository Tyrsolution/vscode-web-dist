 ...
 *--------------------------------------------------------*/
(function() {
var __m = ["require","exports","vs/editor/common/core/range","vs/editor/common/core/position","vs/base/common/strings","vs/base/common/errors","vs/base/common/lifecycle","vs/editor/common/diff/algorithms/diffAlgorithm","vs/base/common/platform","vs/base/common/event","vs/base/common/assert","vs/base/common/objects","vs/editor/common/diff/linesDiffComputer","vs/base/common/uri","vs/base/common/functional","vs/base/common/iterator","vs/base/common/linkedList","vs/base/common/types","vs/base/common/uint","vs/editor/common/core/characterClassifier","vs/editor/common/core/lineRange","vs/editor/common/core/wordHelper","vs/base/common/stopwatch","vs/base/common/cancellation","vs/base/common/diff/diff","vs/editor/common/diff/smartLinesDiffComputer","vs/base/common/diff/diffChange","vs/base/common/arrays","vs/base/common/keyCodes","vs/base/common/lazy","vs/base/common/codicons","vs/editor/common/core/selection","vs/editor/common/core/wordCharacterClassifier","vs/editor/common/diff/algorithms/joinSequenceDiffs","vs/editor/common/diff/algorithms/myersDiffAlgorithm","vs/editor/common/diff/algorithms/utils","vs/editor/common/diff/algorithms/dynamicProgrammingDiffing","vs/editor/common/diff/standardLinesDiffComputer","vs/editor/common/languages/linkComputer","vs/editor/common/languages/supports/inplaceReplaceSupport","vs/editor/common/model","vs/editor/common/model/prefixSumComputer","vs/editor/common/standalone/standaloneEnums","vs/nls!vs/base/common/platform","vs/base/common/process","vs/base/common/path","vs/base/common/cache","vs/base/common/hash","vs/editor/common/diff/linesDiffComputers","vs/editor/common/model/mirrorTextModel","vs/editor/common/model/textModelSearch","vs/editor/common/services/unicodeTextModelHighlighter","vs/editor/common/tokenizationRegistry","vs/editor/common/languages","vs/editor/common/services/editorBaseApi","vs/css","vs/nls","vs/nls!vs/editor/common/services/editorSimpleWorker","vs/base/common/worker/simpleWorker","vs/editor/common/services/editorSimpleWorker"];
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[55/*vs/css*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
...
define(__m[5/*vs/base/common/errors*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.BugIndicatingError = exports.ErrorNoTelemetry = exports.ExpectedError = exports.NotSupportedError = exports.NotImplementedError = exports.getErrorMessage = exports.disposed = exports.readonly = exports.illegalState = exports.illegalArgument = exports.canceled = exports.CancellationError = exports.isCancellationError = exports.transformErrorForSerialization = exports.onUnexpectedExternalError = exports.onUnexpectedError = exports.isSigPipeError = exports.setUnexpectedErrorHandler = exports.errorHandler = exports.ErrorHandler = void 0;
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[27/*vs/base/common/arrays*/], __M([0/*require*/,1/*exports*/,5/*vs/base/common/errors*/]), function (require, exports, errors_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[10/*vs/base/common/assert*/], __M([0/*require*/,1/*exports*/,5/*vs/base/common/errors*/]), function (require, exports, errors_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[28/*vs/base/common/keyCodes*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[29/*vs/base/common/lazy*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Lazy = void 0;
    class Lazy {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[6/*vs/base/common/lifecycle*/], __M([0/*require*/,1/*exports*/,14/*vs/base/common/functional*/,15/*vs/base/common/iterator*/]), function (require, exports, functional_1, iterator_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[20/*vs/editor/common/core/lineRange*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[21/*vs/editor/common/core/wordHelper*/], __M([0/*require*/,1/*exports*/,15/*vs/base/common/iterator*/,6/*vs/base/common/lifecycle*/,16/*vs/base/common/linkedList*/]), function (require, exports, iterator_1, lifecycle_1, linkedList_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[7/*vs/editor/common/diff/algorithms/diffAlgorithm*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[33/*vs/editor/common/diff/algorithms/joinSequenceDiffs*/], __M([0/*require*/,1/*exports*/,7/*vs/editor/common/diff/algorithms/diffAlgorithm*/]), function (require, exports, diffAlgorithm_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[34/*vs/editor/common/diff/algorithms/myersDiffAlgorithm*/], __M([0/*require*/,1/*exports*/,7/*vs/editor/common/diff/algorithms/diffAlgorithm*/]), function (require, exports, diffAlgorithm_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[36/*vs/editor/common/diff/algorithms/dynamicProgrammingDiffing*/], __M([0/*require*/,1/*exports*/,7/*vs/editor/common/diff/algorithms/diffAlgorithm*/,35/*vs/editor/common/diff/algorithms/utils*/]), function (require, exports, diffAlgorithm_1, utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[12/*vs/editor/common/diff/linesDiffComputer*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.RangeMapping = exports.LineRangeMapping = void 0;
    /**
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[37/*vs/editor/common/diff/standardLinesDiffComputer*/], __M([0/*require*/,1/*exports*/,10/*vs/base/common/assert*/,20/*vs/editor/common/core/lineRange*/,3/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/,7/*vs/editor/common/diff/algorithms/diffAlgorithm*/,36/*vs/editor/common/diff/algorithms/dynamicProgrammingDiffing*/,33/*vs/editor/common/diff/algorithms/joinSequenceDiffs*/,34/*vs/editor/common/diff/algorithms/myersDiffAlgorithm*/,12/*vs/editor/common/diff/linesDiffComputer*/]), function (require, exports, assert_1, lineRange_1, position_1, range_1, diffAlgorithm_1, dynamicProgrammingDiffing_1, joinSequenceDiffs_1, myersDiffAlgorithm_1, linesDiffComputer_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class StandardLinesDiffComputer {
        ...
        computeDiff(originalLines, modifiedLines, options) {
            ...
            const scanForWhitespaceChanges = (equalLinesCount) => {
                for (let i = 0; i < equalLinesCount; i++) {
                    ...
                    if (originalLines[seq1Offset] !== modifiedLines[seq2Offset]) {
                        ...
                        const characterDiffs = this.f(originalLines, modifiedLines, new diffAlgorithm_1.SequenceDiff(new diffAlgorithm_1.OffsetRange(seq1Offset, seq1Offset + 1), new diffAlgorithm_1.OffsetRange(seq2Offset, seq2Offset + 1)));
            ...
            for (const diff of lineAlignments) {
                ...
                const characterDiffs = this.f(originalLines, modifiedLines, diff);
                for (const a of characterDiffs) {
                    alignments.push(a);
                }
            }
        ...
        f(originalLines, modifiedLines, diff) {
    ...
    function lineRangeMappingFromRangeMappings(alignments) {
        ...
        for (const g of group(alignments, (a1, a2) => (a2.originalRange.startLineNumber - (a1.originalRange.endLineNumber - (a1.originalRange.endColumn > 1 ? 0 : 1)) <= 1)
            ...
            changes.push(new linesDiffComputer_1.LineRangeMapping(new lineRange_1.LineRange(first.originalRange.startLineNumber, last.originalRange.endLineNumber + (last.originalRange.endColumn > 1 || last.modifiedRange.endColumn > 1 ? 1 : 0)), new lineRange_1.LineRange(first.modifiedRange.startLineNumber, last.modifiedRange.endLineNumber + (last.originalRange.endColumn > 1 || last.modifiedRange.endColumn > 1 ? 1 : 0)), g));
        }
        (0, assert_1.assertFn)(() => {
    ...
    class Slice {
        ...
        get text() {
            return [...this.b].map(e => String.fromCharCode(e)).join('');
        }
        getElement(offset) {
            return this.b[offset];
        }
        ...
        findWordContaining(offset) {
            ...
            return new diffAlgorithm_1.OffsetRange(start, end);
        }
    }
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[38/*vs/editor/common/languages/linkComputer*/], __M([0/*require*/,1/*exports*/,19/*vs/editor/common/core/characterClassifier*/]), function (require, exports, characterClassifier_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[39/*vs/editor/common/languages/supports/inplaceReplaceSupport*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[40/*vs/editor/common/model*/], __M([0/*require*/,1/*exports*/,11/*vs/base/common/objects*/]), function (require, exports, objects_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[41/*vs/editor/common/model/prefixSumComputer*/], __M([0/*require*/,1/*exports*/,27/*vs/base/common/arrays*/,18/*vs/base/common/uint*/]), function (require, exports, arrays_1, uint_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[42/*vs/editor/common/standalone/standaloneEnums*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[43/*vs/nls!vs/base/common/platform*/], __M([56/*vs/nls*/,57/*vs/nls!vs/editor/common/services/editorSimpleWorker*/]), function(nls, data) { return nls.create("vs/base/common/platform", data); });
define(__m[8/*vs/base/common/platform*/], __M([0/*require*/,1/*exports*/,43/*vs/nls!vs/base/common/platform*/]), function (require, exports, nls) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[44/*vs/base/common/process*/], __M([0/*require*/,1/*exports*/,8/*vs/base/common/platform*/]), function (require, exports, platform_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[45/*vs/base/common/path*/], __M([0/*require*/,1/*exports*/,44/*vs/base/common/process*/]), function (require, exports, process) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[22/*vs/base/common/stopwatch*/], __M([0/*require*/,1/*exports*/,8/*vs/base/common/platform*/]), function (require, exports, platform_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[9/*vs/base/common/event*/], __M([0/*require*/,1/*exports*/,5/*vs/base/common/errors*/,14/*vs/base/common/functional*/,6/*vs/base/common/lifecycle*/,16/*vs/base/common/linkedList*/,22/*vs/base/common/stopwatch*/]), function (require, exports, errors_1, functional_1, lifecycle_1, linkedList_1, stopwatch_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class Emitter {
        constructor(options) {
            ...
            this.g = this.d?._profName ? new EventProfiling(this.d._profName) : undefined;
            this.m = this.d?.deliveryQueue;
        }
        dispose() {
            if (!this.j) {
                this.j = true;
                ...
                if (this.q) {
                    if (_enableDisposeWithListenerWarning) {
                        const listeners = Array.from(this.q);
                        queueMicrotask(() => {
        ...
        get event() {
            if (!this.l) {
                this.l = (callback, thisArgs, disposables) => {
                    ...
                    if (this.f && this.q.size > this.f.threshold * 3) {
                        console.warn(`[${this.f.name}] REFUSES to accept new listeners because it exceeded its threshold by far`);
                        return lifecycle_1.Disposable.None;
                    }
                    const firstListener = this.q.isEmpty();
                    if (firstListener && this.d?.onWillAddFirstListener) {
                        this.d.onWillAddFirstListener(this);
                    }
                    let removeMonitor;
                    let stack;
                    if (this.f && this.q.size >= Math.ceil(this.f.threshold * 0.2)) {
                        // check and record this emitter for potential leakage
                        stack = Stacktrace.create();
                        removeMonitor = this.f.check(stack, this.q.size + 1);
                    }
                    if (_enableDisposeWithListenerWarning) {
                        stack = stack ?? Stacktrace.create();
                    }
                    const listener = new Listener(callback, thisArgs, stack);
                    const removeListener = this.q.push(listener);
                    if (firstListener && this.d?.onDidAddFirstListener) {
                        this.d.onDidAddFirstListener(this);
                    }
                    if (this.d?.onDidAddListener) {
                    ...
                    const result = listener.subscription.set(() => {
                        ...
                        if (!this.j) {
                            ...
                            if (this.d && this.d.onDidRemoveLastListener) {
                                const hasListeners = (this.q && !this.q.isEmpty());
                                if (!hasListeners) {
        ...
        fire(event) {
            if (this.q) {
                ...
                // the driver of this
                if (!this.m) {
                    this.m = new PrivateEventDeliveryQueue(this.d?.onListenerError);
                }
                for (const listener of this.q) {
                    this.m.push(this, listener, event);
                }
                // start/stop performance insight collection
                this.g?.start(this.m.size);
                this.m.deliver();
                this.g?.stop();
            }
        }
    ...
    class EventDeliveryQueue {
        constructor(d = errors_1.onUnexpectedError) {
            this.d = d;
    ...
    class AsyncEmitter extends Emitter {
        async fireAsync(data, token, promiseJoin) {
            ...
            for (const listener of this.q) {
                this.c.push([listener, data]);
            }
            while (this.c.size > 0 && !token.isCancellationRequested) {
                const [listener, data] = this.c.shift();
                const thenables = [];
                const event = {
                    ...data,
                    token,
    ...
    class PauseableEmitter extends Emitter {
        constructor(options) {
            super(options);
            this.h = 0;
            this.s = new linkedList_1.LinkedList();
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[46/*vs/base/common/cache*/], __M([0/*require*/,1/*exports*/,23/*vs/base/common/cancellation*/]), function (require, exports, cancellation_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[4/*vs/base/common/strings*/], __M([0/*require*/,1/*exports*/,46/*vs/base/common/cache*/,29/*vs/base/common/lazy*/]), function (require, exports, cache_1, lazy_1) {
    "use strict";
    var _a;
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[47/*vs/base/common/hash*/], __M([0/*require*/,1/*exports*/,4/*vs/base/common/strings*/]), function (require, exports, strings) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[24/*vs/base/common/diff/diff*/], __M([0/*require*/,1/*exports*/,26/*vs/base/common/diff/diffChange*/,47/*vs/base/common/hash*/]), function (require, exports, diffChange_1, hash_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[13/*vs/base/common/uri*/], __M([0/*require*/,1/*exports*/,45/*vs/base/common/path*/,8/*vs/base/common/platform*/]), function (require, exports, paths, platform_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[58/*vs/base/common/worker/simpleWorker*/], __M([0/*require*/,1/*exports*/,5/*vs/base/common/errors*/,9/*vs/base/common/event*/,6/*vs/base/common/lifecycle*/,11/*vs/base/common/objects*/,8/*vs/base/common/platform*/,4/*vs/base/common/strings*/]), function (require, exports, errors_1, event_1, lifecycle_1, objects_1, platform_1, strings) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[25/*vs/editor/common/diff/smartLinesDiffComputer*/], __M([0/*require*/,1/*exports*/,24/*vs/base/common/diff/diff*/,12/*vs/editor/common/diff/linesDiffComputer*/,4/*vs/base/common/strings*/,2/*vs/editor/common/core/range*/,10/*vs/base/common/assert*/,20/*vs/editor/common/core/lineRange*/]), function (require, exports, diff_1, linesDiffComputer_1, strings, range_1, assert_1, lineRange_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[48/*vs/editor/common/diff/linesDiffComputers*/], __M([0/*require*/,1/*exports*/,25/*vs/editor/common/diff/smartLinesDiffComputer*/,37/*vs/editor/common/diff/standardLinesDiffComputer*/]), function (require, exports, smartLinesDiffComputer_1, standardLinesDiffComputer_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[49/*vs/editor/common/model/mirrorTextModel*/], __M([0/*require*/,1/*exports*/,4/*vs/base/common/strings*/,3/*vs/editor/common/core/position*/,41/*vs/editor/common/model/prefixSumComputer*/]), function (require, exports, strings_1, position_1, prefixSumComputer_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class MirrorTextModel {
        ...
        onEvents(e) {
            ...
            for (const change of changes) {
                this.o(change.range);
                this.p(new position_1.Position(change.range.startLineNumber, change.range.startColumn), change.text);
            }
            this.h = e.versionId;
            this.k = null;
        }
        l() {
            if (!this.j) {
                ...
                this.j = new prefixSumComputer_1.PrefixSumComputer(lineStartValues);
            }
        }
        /**
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[50/*vs/editor/common/model/textModelSearch*/], __M([0/*require*/,1/*exports*/,4/*vs/base/common/strings*/,32/*vs/editor/common/core/wordCharacterClassifier*/,3/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/,40/*vs/editor/common/model*/]), function (require, exports, strings, wordCharacterClassifier_1, position_1, range_1, model_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[51/*vs/editor/common/services/unicodeTextModelHighlighter*/], __M([0/*require*/,1/*exports*/,2/*vs/editor/common/core/range*/,50/*vs/editor/common/model/textModelSearch*/,4/*vs/base/common/strings*/,10/*vs/base/common/assert*/,21/*vs/editor/common/core/wordHelper*/]), function (require, exports, range_1, textModelSearch_1, strings, assert_1, wordHelper_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[52/*vs/editor/common/tokenizationRegistry*/], __M([0/*require*/,1/*exports*/,9/*vs/base/common/event*/,6/*vs/base/common/lifecycle*/]), function (require, exports, event_1, lifecycle_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[53/*vs/editor/common/languages*/], __M([0/*require*/,1/*exports*/,30/*vs/base/common/codicons*/,13/*vs/base/common/uri*/,2/*vs/editor/common/core/range*/,52/*vs/editor/common/tokenizationRegistry*/]), function (require, exports, codicons_1, uri_1, range_1, tokenizationRegistry_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ExternalUriOpenerPriority = exports.TokenizationRegistry = exports.LazyTokenizationSupport = exports.InlayHintKind = exports.CommentMode = exports.CommentThreadState = exports.CommentThreadCollapsibleState = exports.Command = exports.FoldingRangeKind = exports.SymbolKinds = exports.SymbolTag = exports.SymbolKind = exports.isLocationLink = exports.DocumentHighlightKind = exports.SignatureHelpTriggerKind = exports.CodeActionTriggerType = exports.InlineCompletionTriggerKind = exports.CompletionTriggerKind = exports.CompletionItemInsertTextRule = exports.CompletionItemTag = exports.CompletionItemKinds = exports.CompletionItemKind = exports.EncodedTokenizationResult = exports.TokenizationResult = exports.Token = void 0;
    class Token {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[54/*vs/editor/common/services/editorBaseApi*/], __M([0/*require*/,1/*exports*/,23/*vs/base/common/cancellation*/,9/*vs/base/common/event*/,28/*vs/base/common/keyCodes*/,13/*vs/base/common/uri*/,3/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/,31/*vs/editor/common/core/selection*/,53/*vs/editor/common/languages*/,42/*vs/editor/common/standalone/standaloneEnums*/]), function (require, exports, cancellation_1, event_1, keyCodes_1, uri_1, position_1, range_1, selection_1, languages_1, standaloneEnums) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[59/*vs/editor/common/services/editorSimpleWorker*/], __M([0/*require*/,1/*exports*/,24/*vs/base/common/diff/diff*/,13/*vs/base/common/uri*/,3/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/,49/*vs/editor/common/model/mirrorTextModel*/,21/*vs/editor/common/core/wordHelper*/,38/*vs/editor/common/languages/linkComputer*/,39/*vs/editor/common/languages/supports/inplaceReplaceSupport*/,54/*vs/editor/common/services/editorBaseApi*/,22/*vs/base/common/stopwatch*/,51/*vs/editor/common/services/unicodeTextModelHighlighter*/,25/*vs/editor/common/diff/smartLinesDiffComputer*/,12/*vs/editor/common/diff/linesDiffComputer*/,48/*vs/editor/common/diff/linesDiffComputers*/,11/*vs/base/common/objects*/,5/*vs/base/common/errors*/]), function (require, exports, diff_1, uri_1, position_1, range_1, mirrorTextModel_1, wordHelper_1, linkComputer_1, inplaceReplaceSupport_1, editorBaseApi_1, stopwatch_1, unicodeTextModelHighlighter_1, smartLinesDiffComputer_1, linesDiffComputer_1, linesDiffComputers_1, objects_1, errors_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class MirrorModel extends mirrorTextModel_1.MirrorTextModel {
        ...
        getWordAtPosition(position, wordDefinition) {
            const wordAtText = (0, wordHelper_1.getWordAtText)(position.column, (0, wordHelper_1.ensureValidWordDefinition)(wordDefinition), this.f[position.lineNumber - 1], 0);
            if (wordAtText) {
    ...
    class EditorSimpleWorker {
        ...
        async computeHumanReadableDiff(modelUrl, edits) {
            const model = this.j(modelUrl);
            if (!model) {
                return edits;
            }
            ...
            for (let { range, text, eol } of edits) {
                ...
                const diff = linesDiffComputers_1.linesDiffComputers.experimental.computeDiff(originalLines, modifiedLines, { maxComputationTimeMs: 1000, ignoreTrimWhitespace: false });
                // TODO this should be fixed in the experimental diff algorithm, but it might have consequences for the merge editor.
                function moveUpInvalidInnerChanges(alignments, originalLineCount, modifiedLineCount) {
                    return alignments.map(a => {
                        if (!a.innerChanges) {
                            return a;
                        }
                        return new linesDiffComputer_1.LineRangeMapping(a.originalRange, a.modifiedRange, a.innerChanges.map(c => {
                            if (c.originalRange.endColumn === 1 && c.originalRange.endLineNumber > originalLineCount) {
                                if (c.originalRange.isEmpty() || c.modifiedRange.isEmpty()) {
                                    return new linesDiffComputer_1.RangeMapping(new range_1.Range(c.originalRange.startLineNumber - 1, Number.MAX_SAFE_INTEGER, c.originalRange.endLineNumber - 1, Number.MAX_SAFE_INTEGER), new range_1.Range(c.modifiedRange.startLineNumber - 1, Number.MAX_SAFE_INTEGER, c.modifiedRange.endLineNumber - 1, Number.MAX_SAFE_INTEGER));
                                }
                                else {
                                    return new linesDiffComputer_1.RangeMapping(new range_1.Range(c.originalRange.startLineNumber, c.originalRange.startColumn, c.originalRange.endLineNumber - 1, Number.MAX_SAFE_INTEGER), new range_1.Range(c.modifiedRange.startLineNumber, c.modifiedRange.startColumn, c.modifiedRange.endLineNumber - 1, Number.MAX_SAFE_INTEGER));
                                }
                            }
                            return c;
                        }));
        ...
        loadForeignModule(moduleId, createData, foreignHostMethods) {
            ...
            if (this.g) {
                ...
                return Promise.resolve((0, objects_1.getAllMethodNames)(this.h));
            }
            // ESM-comment-begin
            return new Promise((resolve, reject) => {
                require([moduleId], (foreignModule) => {
                    this.h = foreignModule.create(ctx, createData);
                    resolve((0, objects_1.getAllMethodNames)(this.h));
                }, reject);
            });
            // ESM-comment-end
            // ESM-uncomment-begin
    ...
    // ---- END diff --------------------------------------------------------------------------
    // ---- BEGIN minimal edits ---------------------------------------------------------------
    EditorSimpleWorker.o = 100000;
    // ---- BEGIN suggest --------------------------------------------------------------------------
    EditorSimpleWorker.p = 10000;
